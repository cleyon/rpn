...
def p_push_case_scope(p):               # pylint: disable=unused-argument
...
def p_pop_case_scope(p):                # pylint: disable=unused-argument
...
def p_sequence(p):
    ...
    # `locals_scope' is an rpn.util.Scope; `executables_list' is an rpn.util.List
